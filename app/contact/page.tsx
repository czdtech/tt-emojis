      ...
      <main className="flex-1 container mx-auto px-4 py-16 max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-700">
            <a href="mailto:support@tiktokemojishub.com" className="text-blue-600 underline">support@tiktokemojishub.com</a>
          </p>
        </div>
        <div>
          <h2 className="text-2xl font-semibold mb-2">Feedback & Suggestions</h2>
          <p className="text-gray-700">
            We welcome your ideas to improve TikTok Emojis Hub. Please email us or use the feedback form below.
          </p>
        </div>
        {/* 可扩展：后续可加表单 */}
      </main>
